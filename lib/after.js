...
module.exports = function afterGenerate(scope, cb) {
  ...
  // Merge webpack dependencies in sails package.json
  let sailsPackage = jsonfile.readFileSync(scope.rootPath + '/package.json');
  let webpackPackage = require(scope.rootPath + '/webpack/package.json');

  sailsPackage.dependencies = _.assign(sailsPackage.dependencies || {}, webpackPackage.dependencies);
  sailsPackage.dependencies["sails-hook-webpack2"] = "https://github.com/Tarrask/sails-hook-webpack2.git#master";

  sailsPackage.devDependencies = _.assign(sailsPackage.devDependencies || {}, webpackPackage.devDependencies);
  

  jsonfile.writeFileSync(scope.rootPath + '/package.json', sailsPackage, {spaces: 2});
